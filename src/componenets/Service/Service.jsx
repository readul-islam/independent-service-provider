...
const Service = ({service}) => {
    ...
    return (
        ...
        <Link to='/checkout' className='lg:px-4 px-2  font-semibold lg:py-2 py-1 rounded-full bg-[rgb(99,214,196)]/80 hover:bg-[rgb(99,214,196)] lg:shadow-2xl '>checkout</Link>
