...
const SignUp = () => {
  const {getEmail,getPassword,getConfirmPassword, checkbox, chackehandler, errors} = useInputValue();
      ...
      <div className=" md:w-[600px] w-[90%] bg-[rgb(41,55,75)] mx-auto rounded-2xl shadow-2xl shadow-[rgb(41,55,75)]/75">
        <div className="w-full lg:px-20 p-4 ">
          ...
          <form className="w-full pt-8">
            ...
            <div className="mb-10">
            <label>E-MAIL</label>
            <input onChange={getEmail}  type="email" placeholder="Enter your email" />
           ...
           <label>PASSWORD</label>
            <input onChange={getPassword} type="password" placeholder="Enter your password" />
            <p className="text-red-500 pt-1 ">{errors?.passwordErrors}</p>
           </div>
          
           <div className='mb-10'>
           <label>Confirm Password</label>
            <input onChange={getConfirmPassword}  type="password" placeholder="Enter your confirm password" />
            <p className="text-red-500 pt-1 ">{errors?.confirmPasswordErrors}</p>
           </div>
           

            <span>
              <input onClick={chackehandler} className=" w-3" ch type="checkbox" />
              <span className="ml-2">
                I agree all{" "}
            ...
            <div className=" md:flex justify-center mt-10 space-y-4 md:space-x-4 md:items-center">
              <button className="bg-[rgb(99,214,196)] md:text-xl font-semibold px-4  md:px-6 py-1 md:py-3 rounded-full ">
                Sign Up
              </button>
